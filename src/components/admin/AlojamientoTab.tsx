...
export function AlojamientoTab({ inscriptos, userRol, onEstadoChange }: Props) {
  ...
  return (
    <div>
      {!esEditor && (
        <div className="flex items-center gap-3 bg-[#1a1a1a] border border-dorado/30 rounded-xl px-4 py-3 mb-5 print:hidden">
          ...
          <p className="text-sm text-[#CCCCCC]">
            Solo <span className="text-dorado font-semibold">giseavit@gmail.com</span> puede modificar este campo.
          </p>
        </div>
      )}
